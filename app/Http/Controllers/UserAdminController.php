...
class UserAdminController extends Controller
{
    ...
    {
        return view('contents.user.userAdmin.index');
    }
    ...
    {
        return view('contents.user.userAdmin.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.index')->with('success', 'Berhasil membuat admin!');
    }
    ...
    {
        $data['admin'] = UserData::find($id);

        return view('contents.user.userAdmin.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.index')->with('success', 'Berhasil mengupdate admin!');
    }

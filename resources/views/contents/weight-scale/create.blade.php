...
@section('title', 'Create trash bin counter')
...
@section('breadcumb')
    ...
    <div class="page-header">
        ...
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Create trash Bin Counter</li>
        </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
        ...
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                <div class="card-title">
                    Create trash bin counter
                </div>
            </div>
            <form id="form" action="{{ route('weight-scale.store') }}" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    @csrf
                    <input id="id" name="id" type="hidden" value="">
                    <div class="mb-3">
                        <p class="fw-semibold mb-2">Petugas</p>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="unique_id" value="{{ $unique_id }}" required readonly>
                    </div>
                    <div class="mb-3">
                        <label for="form-name" class="form-label fs-14 text-dark">Nama Alat</label>
                        <input type="text" class="form-control" name="name" value="{{ old('name') }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="form-latitude" class="form-label fs-14 text-dark">Latitude</label>
                        <input type="text" class="form-control" name="latitude" placeholder="Biarkan kosong!" value="{{ old('latitude') }}" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="form-longitude" class="form-label fs-14 text-dark">Longitude</label>
                        <input type="text" class="form-control" name="longitude" placeholder="Biarkan kosong!" value="{{ old('longitude')}}" readonly>
                    </div>
                </div>

...
@section('title', 'Data / Trash-Data-by-type')
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Pengelolaan Data Sampah Kepemilikan (Berdasarkan Type)</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="card custom-card">
            <div class="card-header">
                <div class="card-title">
                    Pengelolaan Data Sampah Kepemilikan (Berdasarkan Type)
                </div>
            </div>
            <div class="card-body">
                <div class="col-xl-12">
...
<script>
    ...
    var table = $("#datatable").DataTable({
        ...
        autoWidth: false,
        ajax: {
            url: "{{ route('trash-data-by-type.datatable') }}",
            data: function (d) {
        ...
        columns: [
            ...
            { data: 'jam' },
            { data: 'type_sampah' },
            { data: 'detail_type_sampah', defaultContent: '-' },
            { data: 'berat' }
        ],
        language: {

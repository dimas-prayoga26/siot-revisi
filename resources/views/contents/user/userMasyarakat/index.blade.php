        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Pengelolaan Akun Masyarakat</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="card custom-card">
            <div class="card-header">
                <div class="card-title">
                    Pengelolaan Akun Masyarakat
                </div>
            </div>
            <div class="card-body">
                <a href="{{ route('masyarakat.create') }}" class="btn btn-primary mb-4 data-table-btn"><i class="las la-plus"></i> masyarakat</a>
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $("#datatable").DataTable({
            ...
            serverSide: true,
            autoWidth: false,
            ajax: "{{ route('masyarakat.datatable') }}",
            columnDefs: [
            {
                targets: 0,
            ...
            },
            {
                ...
                render: function(data) {
                    let btn = `
                    <div class="btn-list">
                        <a href="{{ route('masyarakat.edit', ':id') }}" class="btn btn-md btn-primary"><span class="fe fe-edit"> </span></a>

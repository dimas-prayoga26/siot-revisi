...
@section('title', 'User / gerbege-officer')
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Pengelolaan Petugas</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="row">
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <div class="card-body">
                <a href="{{ route('petugas.create') }}" class="btn btn-primary mb-4 data-table-btn"><i class="las la-plus"></i> Petugas</a>
        ...
        table = $("#datatable").DataTable({
            ...
            },
            {
                ...
                render: function(data) {
                    let btn = `
                    <div class="btn-list">
                        <a href="{{ route('petugas.edit', ':id') }}" class="btn btn-md btn-primary"><span class="fe fe-edit"> </span></a>
